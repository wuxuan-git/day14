...
<div class="modal-body">
	<form id="form_user" method="post" action="reserveUser.htm">
		...
		<table style="border-collapse:separate; border-spacing:0px 10px;">
			<tr>
				<td>学生姓名：</td>
				<td><input type="text" id="sName1" name="sName"
			...
			<tr>
				...
				<select class="form-control" name="courseId" id ="courseId" aria-required="true" required>
					...
					<td>入校时间：</td>
					<td>
					<input type="date" id="sEntryTime1" name="sEntryTime"
	...
	<!-- 新增课程信息 -->
	<div class="modal fade" id="modal_user_course" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
<div class="modal-body">
	...
	<div class="modal fade" id="modal_user_count" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					 <h4 class="modal-title" id="modal_user_del_head">echarts报表饼图  </h4>
				</div>
				<div class="modal-body">
