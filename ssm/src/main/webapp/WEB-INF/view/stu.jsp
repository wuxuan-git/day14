        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="time1" class="form-control" id="txt_search_time1" >
			      <input type="date" name="time2" class="form-control" id="txt_search_time2" >
				</div>
			  </div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td><input type="radio" id="sSex1" name="sSex" value="女"
									 aria-required="true" required/>女
								<td><input type="radio" id="sSex2" name="sSex" value="男"
							...
							<tr>
								...
								<input type="checkbox" id="sHobby2" name="sHobby"
								 aria-required="true" value="足球" required/>足球
								<input type="checkbox" id="sHobby3" name="sHobby"
								 aria-required="true" value="排球" required/>排球
